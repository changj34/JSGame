...
const htmlPath = __dirname + '/index.html'; //link index.html

describe('Source code is valid', () => {
  test('HTML validates without errors', async () => {
    const lintOpts = {
      'attr-bans':['align', 'background', 'bgcolor', 'border', 'frameborder', 'marginwidth', 'marginheight', 'scrolling'], //adding height, allow longdesc
      'doctype-first':true,
      'doctype-html5':true,
      'html-req-lang':true,
  ...
  test('JavaScript validates without errors', () => {
    expect(['js/*.js']).toHaveNoEsLintErrors();
  })
});
